...
(function($){
    ...
    Redactor.prototype = {
        ...
        showImage: function()
        {
            ...
            //selectImage();
            this.modalInit(RLANG.image, this.opts.modal_image, 0, callback);
        },
